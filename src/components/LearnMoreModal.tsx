...
export const LearnMoreModal = ({ open, onOpenChange }: LearnMoreModalProps) => {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-5xl max-h-[90vh] overflow-hidden p-0 gap-0 animate-in fade-in-0 zoom-in-95 duration-300">
        <div className="overflow-y-auto max-h-[90vh]">
          {/* Animated Header */}
        <DialogHeader className="relative p-8 bg-gradient-to-br from-primary via-accent to-primary text-white">
          ...
          <div className="relative z-10">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <DialogTitle className="text-3xl font-bold">Student Dropout Prevention System</DialogTitle>
        ...
        <div className="border-b bg-card/50 backdrop-blur-sm sticky top-0 z-10">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            {/* Overview Tab */}
            <TabsContent value="overview" className="p-8 space-y-6 animate-in fade-in-0 slide-in-from-right-4 duration-500">
            ...
            {/* How It Works Tab */}
            <TabsContent value="how-it-works" className="p-8 space-y-6 animate-in fade-in-0 slide-in-from-right-4 duration-500">
            ...
            {/* HOD Guide Tab */}
            <TabsContent value="hod-guide" className="p-8 space-y-6 animate-in fade-in-0 slide-in-from-right-4 duration-500">
            ...
            {/* Teacher Guide Tab */}
            <TabsContent value="teacher-guide" className="p-8 space-y-6 animate-in fade-in-0 slide-in-from-right-4 duration-500">
              <div className="space-y-4">
                <GuideSection
            ...
            {/* Student Guide Tab */}
            <TabsContent value="student-guide" className="p-8 space-y-6 animate-in fade-in-0 slide-in-from-right-4 duration-500">
              <div className="space-y-4">
                <GuideSection
                  title="Login"
                  steps={[
